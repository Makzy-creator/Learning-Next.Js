import { SteponeField } from '@/app/lib/definitions';
import Link from 'next/link';
import { FaCheck, FaClock, FaDollarSign, FaUserCircle } from 'react-icons/fa';
import { Button } from '@/app/ui/buttons';
import { createInvoice } from '@/app/lib/actions';

export default function Form({ customers }: { customers: SteponeField[] }) {
  return (
